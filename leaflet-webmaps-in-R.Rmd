...
**Important** don't call your map object `map`
...
The map will automatically center on the data and determine an appropriate zoom level 

- You don't need to use `setView` (commented out).

- But, you can override this by using `setView`.
...
library(knitr)
purl("leaflet-webmaps-in-R-slides.Rmd", output = "leaflet-webmaps-in-r.R", documentation = 1)
